...
---- [Docs](https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.linregress.html?highlight=linregress#scipy.stats.linregress)

  * **Notes**
    * Everything in the results column can be treated as an attribute and accessed in that way 
...
<div style="padding-left:125px;">
**Examples:** [Civic Vs Corolla](./Analyses/CivicVsCorollaMLR.html)
[cadillacs](./Analyses/cadillacsMLR.html)
</div>
